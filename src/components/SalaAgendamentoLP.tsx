...
<div style="background:#fff;color:#12151C;">
  ...
  <div style="background:#fff;padding:clamp(56px,10vw,96px) clamp(20px,5vw,32px);">
    <div style="max-width:900px;margin:0 auto;text-align:center;">
      <h2 style="font-family:'Plus Jakarta Sans',sans-serif;font-weight:800;font-size:clamp(28px,5.5vw,38px);line-height:1.15;color:#12151C;margin:0 0 22px;text-wrap:pretty;text-align:center;width:100%;max-width:952px;">O LEAD respondeu. Mas você conseguiu agendar?</h2>
  ...
  <div style="background:#fff;padding:clamp(56px,10vw,96px) clamp(20px,5vw,32px);">
    <div style="max-width:1200px;margin:0 auto;">
      <div style="text-align:center;max-width:640px;margin:0 auto 56px;">
        <div style="color:#2F6FE8;font-size:12px;font-weight:700;letter-spacing:1.2px;margin-bottom:14px;">DEPOIMENTOS E RESULTADOS</div>
        <h2 style="font-family:'Plus Jakarta Sans',sans-serif;font-weight:800;font-size:clamp(26px,5vw,36px);line-height:1.18;color:#12151C;margin:0 0 18px;text-wrap:pretty;">Quem aplica, percebe a diferença nas conversas.</h2>
        <p style="font-size:16px;line-height:1.7;color:#4B5568;margin:0;text-wrap:pretty;">Veja o que dizem profissionais que já participaram de treinamentos, análises e acompanhamentos comerciais com a gente.</p>
      </div>
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:24px;margin-bottom:48px;">
        <div style="background:#F4F6FA;border-radius:16px;overflow:hidden;">
          <video controls preload="metadata" style="width:100%;aspect-ratio:9/16;object-fit:cover;display:block;background:#000;">
            <source src="/lp/assets/depoimento-60-dias.mp4" type="video/mp4">
          </video>
        </div>
        <div style="background:#F4F6FA;border-radius:16px;overflow:hidden;">
          <video controls preload="metadata" style="width:100%;aspect-ratio:9/16;object-fit:cover;display:block;background:#000;">
            <source src="/lp/assets/depoimento-ll360.mp4" type="video/mp4">
          </video>
        </div>
        <div style="background:#F4F6FA;border-radius:16px;overflow:hidden;">
          <video controls preload="metadata" style="width:100%;aspect-ratio:9/16;object-fit:cover;display:block;background:#000;">
            <source src="/lp/assets/depoimento-stefesson.mp4" type="video/mp4">
          </video>
        </div>
      </div>
      <div style="max-width:700px;margin:0 auto;text-align:center;">
        <p style="font-size:18px;line-height:1.7;color:#12151C;font-weight:600;margin:0 0 30px;text-wrap:pretty;">Não se trata apenas de falar melhor. É sobre aprender a fazer as perguntas certas, conduzir a conversa, superar objeções e levar o lead até o próximo passo.</p>
        <a href="#planos" class="cta-primary" style="display:inline-block;background:#2F6FE8;color:#fff;font-weight:800;font-size:15px;padding:16px 28px;border-radius:10px;">QUERO EVOLUIR MINHAS CONVERSAS</a>
      </div>
    </div>
  </div>
