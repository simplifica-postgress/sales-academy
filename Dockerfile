...
# Assinatura. O link e o WhatsApp são embutidos no bundle: sem eles aqui, o
# botão de compra da landing sai sem destino, por mais que estejam no painel
# de deploy. PAYWALL nasce "false" de propósito — se alguém esquecer de
# definir, o pior caso é ninguém ser bloqueado, nunca o contrário.
ARG NEXT_PUBLIC_STRIPE_PAYMENT_LINK
ARG NEXT_PUBLIC_SUPPORT_WHATSAPP
ARG NEXT_PUBLIC_PAYWALL=false
...
ENV NEXT_PUBLIC_FIREBASE_API_KEY=$NEXT_PUBLIC_FIREBASE_API_KEY \
    ...
    NEXT_PUBLIC_STRIPE_PAYMENT_LINK=$NEXT_PUBLIC_STRIPE_PAYMENT_LINK \
    NEXT_PUBLIC_SUPPORT_WHATSAPP=$NEXT_PUBLIC_SUPPORT_WHATSAPP \
    NEXT_PUBLIC_PAYWALL=$NEXT_PUBLIC_PAYWALL \
